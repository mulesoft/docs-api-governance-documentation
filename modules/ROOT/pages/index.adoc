...
** Governance leads and security architects can browse policies by category in the Policy Library and apply them directly to one or more API instances, including instances on third-party gateways.
