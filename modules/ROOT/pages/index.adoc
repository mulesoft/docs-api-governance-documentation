...
* In Design Center API Designer, you can check API specification conformance in the API design phase by applying governance rulesets directly to API specifications as dependencies. Use the *Project Errors* section for information about where the issue is in the specification and how to fix it.
