...
In the API Governance console, add <<gov-rulesets,governance rulesets>> to <<gov-profiles,governance profiles>> to apply the governance rulesets to multiple APIs across your organization. The API Governance console then provides you with an overview of conformance for all validated APIs.
Monitor your API conformance and notify developers to help improve the conformance.

Developers with the *Governance Viewer* permission can view the API governance report on the console in view-only mode.
