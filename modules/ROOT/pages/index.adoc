...
enables you to apply governance rules to your *services* — including APIs, agents, MCP servers, and gateways — as part of the service lifecycle.

With Anypoint API Governance:

* Improve your organization's service quality:
+
Identify conformance issues in governed services and take steps to resolve them by adding *governance strategies* to start enforcing standards.
+
* Customize and apply governance rules using the enhanced *Policy Catalog* and *Controls* strategies:
+
Access the full ruleset library with conditions configuration, rule-level selection, and severity customization by creating *Controls* directly in the enhanced MuleSoft experience.
+
...
+
* Apply consistent governance across multiple gateway runtimes:
+
Create governance strategies that target *Omni Gateways*, *Mule Gateways*, or all runtimes simultaneously, ensuring uniform governance posture across your entire service infrastructure.
+
...
The *Policy Catalog* provides a browsable library of governance policies that you can apply directly to your services.
