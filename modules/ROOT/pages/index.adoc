...
include::_partials/api-gov-concepts.adoc[tag=api-entire,leveloffset=+2]

// Definition of API Aspects

include::_partials/api-gov-concepts.adoc[tag=api-aspects,leveloffset=+2]

// Definition of API Specifications

include::_partials/api-gov-concepts.adoc[tag=api-specifications,leveloffset=+3]

// Definition of API Implementation

include::_partials/api-gov-concepts.adoc[tag=api-implementation,leveloffset=+3]

// Definition of API Instances

include::_partials/api-gov-concepts.adoc[tag=api-instances,leveloffset=+3]

// Definition of API Documentation

include::_partials/api-gov-concepts.adoc[tag=api-documentation,leveloffset=+3]

// Definition of API Catalog Information

include::_partials/api-gov-concepts.adoc[tag=api-catalog-info,leveloffset=+3]
