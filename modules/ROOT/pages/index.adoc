...
* xref:general::exp-governance-policy-library-apply.adoc[Universal Policies] (enhanced MuleSoft experience only):

** Governance leads and security architects can browse governance policies by category, and apply them directly to one or more API instances across third-party providers, without creating a governance profile.
