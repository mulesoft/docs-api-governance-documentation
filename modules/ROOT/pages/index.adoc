...
+
* Customize and apply governance rules using the xref:general::exp-governance-policy-library-apply.adoc[*Policy Library*] and xref:general::exp-governance-work-with-strategies.adoc[*Controls*] strategies, available only in the enhanced MuleSoft experience:
+
...
** Governance leads and security architects can browse and apply governance policies directly to individual services or in bulk across all *Agents*, *MCP Servers*, *LLM Proxies*, *APIs*, and *Gateways*.
