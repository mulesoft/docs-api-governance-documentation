...
Anypoint API Governance is integrated with Exchange and Design Center. 

* In Exchange, developers view published APIs' conformance status details, discover provided rulesets, and publish custom rulesets.

* In Design Center API Designer, developers or architects check API conformance in the API design phase by applying governance rulesets directly to API specifications as dependencies. 
