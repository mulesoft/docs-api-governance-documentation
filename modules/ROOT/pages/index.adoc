...
** Governance leads and security architects can browse policies by category and apply them directly to one or more API instances, including instances on third-party gateways.
