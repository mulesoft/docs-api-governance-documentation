...
** Governance leads and security architects can browse governance policies by category, and apply them directly to one or more API instances across connected gateways, without creating a governance profile.
