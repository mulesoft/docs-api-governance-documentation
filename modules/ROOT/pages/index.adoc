...
* In Design Center API Designer, developers or architects can check API conformance in the API design phase by applying governance rulesets directly to API specifications as dependencies. 
