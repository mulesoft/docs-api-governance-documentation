...
* xref:general::exp-governance-work-with-strategies.adoc[Policy Library] (enhanced MuleSoft experience only):

** Governance leads and security architects can browse governance policies by category—*Access and Security*, *Compliance and Observability*, *Data Privacy and Integrity*, and *Performance and Cost*—and apply them directly to one or more API instances across connected gateways, without creating a governance profile.
