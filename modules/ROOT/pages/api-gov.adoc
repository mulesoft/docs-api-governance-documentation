...
<2> View a list summary of your governance profiles or governed APIs.
...
<3> Ensure your conformance issues are resolved before you publish.
...
API conformance indicates whether a governed API definition passes all of the required rules in one or more governance rulesets. If an API definition is included in multiple governance profiles, it must pass all of the rulesets in all of those profiles to be conformant. 
