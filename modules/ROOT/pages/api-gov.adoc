...
API developers or architects can apply the governance rulesets, which are published as assets in Anypoint Exchange, directly to API definitions as dependencies in API Designer during the API design phase. 
