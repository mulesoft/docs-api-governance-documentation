...
To enable and configure conformance notifications in the CLI, when creating or updating a profile using the `governance create profile` or `governance update profile` commands, use the following options:
