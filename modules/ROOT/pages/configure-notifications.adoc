...
Automated notifications are sent when the conformance status changes during validation. Following are the status changes that might cause the status of conformance to change and result in notifications: 
