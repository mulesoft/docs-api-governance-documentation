...
+
. After the validation, view conformance issue details. 
+
* For APIs validated using API Governance (centrally-governed APIs), view conformance information in:
+
** xref:view-conformance-status-in-exchange.adoc[Exchange]
** <<view-spec-issues-in-report,API Governance>>
+ 
* For APIs validated outside of API Governance, view conformance information in:
+
** <<project-errors,Design Center>>
** <<validate-in-cli,Reports generated through CLI>>
+
. Fix specification conformance issues using <<project-errors,Design Center>>. 
