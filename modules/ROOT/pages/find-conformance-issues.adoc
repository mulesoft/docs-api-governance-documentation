...
After the validation, view conformance issue details as follows: 

* For an API validated using API Governance (centrally-governed APIs), view conformance information in the API's:
+
...
After you identify the issues, you can fix them using <<project-errors,Design Center>>. 
