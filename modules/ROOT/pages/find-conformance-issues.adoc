...
In API Designer, you can add governance rulesets to your API projects as Exchange dependencies. See xref:design-center::design-add-api-dependency.adoc[Adding Dependencies to an API-Specification Project].
