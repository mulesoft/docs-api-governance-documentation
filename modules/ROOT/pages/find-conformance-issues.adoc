...
You can validate your API specifications against governance rulesets in Design Center
...
You can use the API Designer text editor to resolve conformance project errors. See xref:design-center::design-create-publish-api-raml-editor.adoc#the-editor[Create an API Specification with the Text Editor].

== Validate API Definitions Against Governance Rulesets Using the API Governance CLI

If you want to use a command to validate your API specification against governance rulesets, use the `governance:api:validate` command.
