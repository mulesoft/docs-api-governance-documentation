...
After you identify conformance issues in your specification, you can fix the issues in API Designer and publish the new version of the specification to Exchange. 
