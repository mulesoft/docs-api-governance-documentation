...
For information on using the API Designer text editor to resolve conformance project errors, see xref:design-center::design-create-publish-api-raml-editor.adoc#the-editor[Create an API Definition with the Text Editor].
