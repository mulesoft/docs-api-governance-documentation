...
Design Center in API Designer. Once added, you will see errors or warnings in the `Project Errors` section of API Designer as you are writing your API definition. 
