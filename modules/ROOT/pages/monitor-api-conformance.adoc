...
On a selected governance profile page, click the overflow menu icon (image:overflow-menu-icon.png[width=0.75%,height=0.75%,title="Screenshot of the overflow menu icon"]) and then select *Export Reports* to export a report that shows the selected governance profile's information, such as: 
