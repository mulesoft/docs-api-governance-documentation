...
The cross-gateway policy audit export consolidates policy application evidence across all connected providers and MuleSoft-native APIs to support compliance audits such as SOC 2 or GDPR.
