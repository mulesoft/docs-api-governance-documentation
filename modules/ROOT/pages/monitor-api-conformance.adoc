...
You can view conformance details for governed APIs in their governance reports in API Governance console and API Manager. See xref:find-and-fix-conformance-issues.adoc[].
...
On the main API Governance console page, select the *Profiles* tab and then click the *Export to CSV* button to export a report of governance profile information, such as: 
...
[[gov-api-export]]
=== Governed API Export
On the main API Governance console page, select the *Governed APIs* tab and then click the *Export to CSV* button to export a report that shows your validated APIs' information, such as:  
