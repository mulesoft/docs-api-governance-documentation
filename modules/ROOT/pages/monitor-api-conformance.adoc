...
To support compliance audits (such as SOC 2 or GDPR), export a cross-gateway policy audit report that consolidates policy application evidence across all connected providers and MuleSoft-native APIs.
