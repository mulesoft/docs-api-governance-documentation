...
. Return to the profile settings and adjust the settings to test different selections until you target the set of APIs you want and apply the optimal set of rules to meet the purpose of the profile. 
