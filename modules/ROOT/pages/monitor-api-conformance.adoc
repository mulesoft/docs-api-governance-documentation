...
Shows the severity of API nonconformance to rulesets based on the percentage of all of required rulesets that the APIs passed. The higher the severity, the fewer rulesets the APIs passed.
+
* High Severity:
+
