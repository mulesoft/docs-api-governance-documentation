...
On a selected governance profile page, click the more options menu icon (image:overflow-menu-icon.png[width=0.90%,height=0.90%,title="Three vertical dots"]) and then select *Export Reports* to export a report that shows the selected governance profile's information, such as: 
...
include::3.x@anypoint-cli::partial$api-governance.adoc[tag=governance-api-evaluate,leveloffset=+1]