...
[[gov-spec-profile-export]]
=== API Conformance Information for a Specific Active Profile
...
[[gov-spec-draft-api-export]]
=== Conformance Information for a Specific Draft Profile
...
. For the profile you want conformance information for, select *Export Report* from the more options menu. 
+
This exports a CSV file with API conformance information for the selected draft profile, such as: 
+ 
* Organization ID 
* API IDs
* API Version
