...
== Testing Profile Settings Using Draft Profiles

Consider using draft profiles to test profile settings. This enables you to ensure you've limited the scope of the profiles to just what you need before alerting the API owners about identified API conformance issues. 
...
. Export a report of only this API's conformance, notify the API owner, or open the API in Exchange.
...
. Edit the profile settings and view the API conformance results for different selections until you target the desired set of APIs and rules. 
...
== Monitoring Conformance Information for Active Profiles
