...
On the main API Governance console page, select the *Profiles* tab and then click the *Export to CSV* button to export governance profile information, such as: 
...
[[gov-api-export]]
=== Governed API Export
On the main API Governance console page, select the *Governed APIs* tab and then click the *Export to CSV* button to export your governed APIs' information, such as:  
...
On a selected governance profile page, click the more options menu icon (image:overflow-menu-icon.png[width=9,height=15,fit=line,title="Three vertical dots"]) and then select *Export to CSV* to export the selected governance profile's information, such as: 
