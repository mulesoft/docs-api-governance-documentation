...
To view API conformance information for APIs targeted by active profiles, view the latest summary information in the API Governance console and in validation reports.
