...
Governed API Report::
On the main API Governance console page, select the *APIs* tab and then click the *Export Report* button to export a report that shows your governed APIs' information, such as:  
...
On a selected governance profile page, select *Export Reports* in the three dots menu to export a report that shows the selected governance profile's information, such as: 
