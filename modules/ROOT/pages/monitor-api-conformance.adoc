...
* Number of nonconformant APIs (fail)
* Timestamp
* Gateway/Provider (for APIs discovered from connected third-party providers; blank for MuleSoft APIs)
...
* Number of nonconformant APIs (fail)
* Timestamp
* Gateway/Provider (for APIs on connected third-party providers; blank for MuleSoft APIs)
