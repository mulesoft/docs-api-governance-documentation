...
On a selected governance profile page, click the more options menu icon (image:overflow-menu-icon.png[width=9,height=15,fit=line,title="Three vertical dots"]) and then click *Export Report* to export the selected governance profile information, such as: 
