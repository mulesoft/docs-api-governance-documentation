...
+
In the sidebar, select the instance you want to review and publish. The stage name from AWS is shown in the name. For example, instance_dev, instance_prod, and instance_qax. 
