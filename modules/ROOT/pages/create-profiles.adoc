...
* *Filter Criteria*: To identify the APIs to which to apply the selected rulesets, select filter criteria such as API type, tags, and categories. The filter criteria applies to your organization's APIs that are in Exchange currently and to your new APIs as they are added to Exchange.
+
