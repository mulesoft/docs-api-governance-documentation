...
Policy Library:: Use this approach to browse available policies and apply one directly as a global policy to selected service instances without creating a full governance profile. The apply workflow follows these steps: 
. Select Policy
. Configure Policy 
. Select Instances 
. Review & Apply
