...
. In *API Governance*, in the console *Profiles* tab, click the more options menu icon (image:overflow-menu-icon.png[width=9,height=15,fit=line]) for profile you want to update and select *Delete*.
. Click *Yes, Delete*.
