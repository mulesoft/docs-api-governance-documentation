...
[NOTE]
====
The *Policy Library* is available only in the enhanced MuleSoft experience. For more information, see xref:general::exp-governance-policy-library-apply.adoc[].
====
