...
If you have connected third-party gateway providers, use this filter to scope the profile to APIs discovered from a specific provider.
+
[NOTE]
====
The *Gateway/Provider* filter is available only in the enhanced MuleSoft experience. For details about connecting providers and using this filter, see xref:general::exp-governance-create-profiles-gateway-provider-filter.adoc[].
====
