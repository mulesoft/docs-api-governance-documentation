...
Universal Policies:: Browse policies and apply them directly to one or more API instances without creating a full governance profile. Use this approach for targeted or supplemental policy application, especially for services discovered from third-party providers.
+
[NOTE]
====
