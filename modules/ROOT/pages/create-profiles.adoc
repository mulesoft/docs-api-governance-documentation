...
CAUTION: If you do not select filter criteria, your governance profile applies to _all_ of your APIs in Exchange.
...
|Review
|Review your profile and click *Save as draft* or *Save as active*:

* Save a profile as draft to experiment with profile settings and review conformance information before governing the APIs. API conformance information for draft profiles is not shown in integrating Anypoint Platform products.
* Save a profile as active to govern the targeted APIs and show API conformance information in integrating Anypoint Platform products.
|
|===
...
. Click *Draft* or *Active*, depending on whether the profile you want to update is draft or active.
...
+
After you apply your edits, the total APIs refresh to indicate how many APIs
your governance profile includes based on your updated filter criteria.

== Activate a Draft Profile Using the API Governance Console

To activate a draft profile using the API Governance console: 
