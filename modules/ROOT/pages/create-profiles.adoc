...
To activate a governance profile using the API Governance console: 

. In *API Governance*, select the console *Profiles* tab.
. Select the *Drafts* tab.
. For the profile you want to activate, click the more options menu icon (image:overflow-menu-icon.png[width=9,height=15,fit=line]) and then select *Activate*.
+
