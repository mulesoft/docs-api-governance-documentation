...
. Follow the user interface prompts to enter the following:
+
...
+
CAUTION: If you do not select filter criteria, your governance profile will be applied to _all_ of your APIs in Exchange.
