...
[NOTE]
====
The *Gateway/Provider* filter and *Platform* > *Providers* connectivity described here are available only in the enhanced MuleSoft experience. See xref:general::exp-governance-work-with-strategies.adoc[].
====
...
+
NOTE: Connect third-party providers via *Platform* > *Providers* before their APIs appear in this filter. See xref:get-started.adoc#third-party-gateway-prereqs[Set Up Third-Party Gateway Connectivity].
