...
* Save a profile as draft to experiment with profile settings and review conformance information before revealing the conformance information for its targeted APIs in integrating Anypoint Platform products.
