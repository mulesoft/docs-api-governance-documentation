...
Universal policies:: Configure a policy once and apply it directly to one or more API instances that you select, including instances on third-party gateways such as Google Apigee, Azure API Management, and Kong Gateway. Use this approach for targeted policy application.
+
[NOTE]
====
