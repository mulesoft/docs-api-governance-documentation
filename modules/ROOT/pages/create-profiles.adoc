...
* *Filter Criteria*: Specify which APIs to which to apply your governance profiles by selecting an API type, tags, and categories. Selections appear in the *Tag* and *Category* fields only if APIs are found that have those tags or categories. See xref:add-tags.adoc[Identifying APIs to Govern].
+
