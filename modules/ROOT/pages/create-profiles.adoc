= Applying Governance Rulesets to Identified APIs
...
[TIP]
====
* Start by creating draft profiles to test settings before revealing the targeted API's conformance across Anypoint Platform.
...
. Click  *Activate* for the profile you want to activate.
+
