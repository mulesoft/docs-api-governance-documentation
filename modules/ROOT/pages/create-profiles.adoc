...
you want to govern, you are ready to create governance profiles. Governance profiles enable you to select the specific sets of APIs to govern for each set of rulesets.
