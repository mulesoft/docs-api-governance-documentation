...
Use both approaches together: govern APIs with profiles for continuous conformance tracking, and use the Policy Library for direct policy application to gateway instances.
====
