...
|Review
|Review your profile and click *Save as active* or *Save as draft*.

Save as draft to experiment with profile settings and review conformance information before governing the APIs. API conformance information shown in draft profiles is not shown in integrating Anypoint Platform products.
|
|===
...
== Activate a Governance Profile Using the API Governance Console
