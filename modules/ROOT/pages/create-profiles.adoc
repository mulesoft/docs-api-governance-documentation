...
you want to govern, you are ready to create governance profiles. Governance profiles enable you to select the specific sets of APIs that you want to govern for each set of rulesets.
...
Use the search box and filters to find the rulesets you want to use. You can filter rulesets by the following:

* Organization
* Tag
* Category

You can select the version of each ruleset you want to use or select the *Latest* option. The default is *Latest*.
...
* The most-frequently used tags in Exchange and any tags you have added to the profile are listed in the *Tags* section. See xref:add-tags.adoc#select-and-add-tags[]. 
...
. In *API Governance*, in the console *Profiles* tab, click the more options menu icon (image:overflow-menu-icon.png[width=9,height=15,fit=line,title="Three vertical dots"]) at the end of the profile you want to update and select *Edit*.
...
. In *API Governance*, in the console *Profiles* tab, click the more options menu icon (image:overflow-menu-icon.png[width=9,height=15,fit=line,title="Three vertical dots"]) at the end of the profile you want to update and select *Delete*.
. Click *Yes, Delete*.
...
include::3.x@anypoint-cli::partial$api-governance.adoc[tag=governance-profile-create,leveloffset=+1]
...
include::3.x@anypoint-cli::partial$api-governance.adoc[tag=governance-profile-list,leveloffset=+1]
...
include::3.x@anypoint-cli::partial$api-governance.adoc[tag=governance-profile-info,leveloffset=+1]
...
include::3.x@anypoint-cli::partial$api-governance.adoc[tag=governance-profile-update,leveloffset=+1]
...
include::3.x@anypoint-cli::partial$api-governance.adoc[tag=governance-profile-delete,leveloffset=+1]