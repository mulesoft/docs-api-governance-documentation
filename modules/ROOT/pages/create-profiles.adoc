...
* *Rulesets*: Select one or more rulesets you want to use to govern your APIs. You can select a specific version if you do not want to use the default, which is the latest version. 
+
Use the search box and filters to find the rulesets you want to use. See <<ruleset-search-filter>>.
+
...
[[ruleset-search-filter]]
== Search and Filter Rulesets

To search and filter to find the rulesets you want to apply to your APIs, use one or more of the following:

* Enter a search string in the *Search* field. 
+
...
** Catalog
+
The default for each is any. When you select the filter, a drop-down menu appears in which you can select from options.
