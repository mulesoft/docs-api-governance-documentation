...
* *Filter Criteria*: To apply selected rulesets to specific APIs, select filter criteria such as API type, tags, and categories. The filter criteria applies to your organization's APIs that are in Exchange and to new APIs as you add them to Exchange.
+
