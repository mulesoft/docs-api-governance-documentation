...
+
After you activate a profile, the APIs validated against the rulesets in that profile become governed APIs and their conformance information appears outside of the draft profile view.
