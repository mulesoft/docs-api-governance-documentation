...
== Governance Profiles Versus the Policy Library
...
Policy Library:: Browse governance policies and apply them directly to one or more API instances without creating a full governance profile. Use this approach for targeted or supplemental policy application, especially for services discovered from third-party providers.
+
[NOTE]
====
The *Policy Library* is available only in the enhanced MuleSoft experience. For more information, see xref:general::exp-governance-work-with-strategies.adoc[].
====
