...
The following table shows some of the rules and the actions that you can take to fix conformance to those rules.
...
|A specification, but relates to instances.
