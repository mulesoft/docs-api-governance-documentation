...
After API Governance identifies conformance issues in your API instances, you can view the governance validation report details to get the information you need to fix the issues. After you identify what needs to be fixed, go to the Anypoint instance in API Manager and fix the issue. If the issue is an instance-related issue in the specification, use your API editor, such as API Designer, to fix the specification.
...
If the nonconformance messages in the governance validation report don't have enough detail to help you fix the issues, you can view more detailed information in the rulesets. 

To view rules details in rulesets:

. In Exchange, open the ruleset. 
. View the documentation for the ruleset.
. To identify the conformance issue, view descriptions and messages for the rules to which your API doesn't conform.
