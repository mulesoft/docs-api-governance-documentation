...
... Click *View Details* for a ruleset the API instances are nonconformant to.
* In API Manager:
.. Select the *Governance Report* page for an instance that has an Instance Conformance badge of *Violation*.
.. In the Instance validation results section, click *View Details* for a ruleset the API instances are in violation of.
