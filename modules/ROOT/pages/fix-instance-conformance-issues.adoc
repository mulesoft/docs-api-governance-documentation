...
Use the information in the xref:find-and-fix-conformance-issues.adoc#governance-validation-report[governance validation report] to determine why the conformance failed.
...
// include::partial$api-gov-apim-ruleset-fix-tips.adoc[]
