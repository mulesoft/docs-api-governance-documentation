...
* Search the https://ideas.salesforce.com/s/search[MuleSoft Ideas Portal^] for ideas for new rulesets. If you don't find your idea there, consider submitting your idea in the MuleSoft Ideas Portal.
...
To create rulesets using the modeling language, read the https://github.com/aml-org/amf-custom-validator/blob/develop/docs/validation_tutorial/validation.md[AMF Custom Validation section^] in the AML Open Source project to learn how to write a ruleset using the modeling language.
