...
If you plan to use the API Governance CLI commands, you must install the API Governance CLI on the systems where you run local commands or where your automatation tools, such as CI/CD pipelines or scripts, are executed.
...
* xref:anypoint-cli::api-gov.adoc[Anypoint CLI Documentation]