...
** To publish a new version of the ruleset, change the version in the command. For example, change `1.0.0` in the original command: 
+
----
...
** To change the asset ID to create a new asset, change the asset ID in the command. For example, change `my-auth-best-practices` in the original command: 
+
----
anypoint-cli-v4 exchange asset upload my-auth-best-practices/1.0.0 --name "My Best Practices Ruleset" --description "This ruleset enforces my best practices for APIs." --files='{"ruleset.yaml":"/myRulesetFolder/mynewruleset.yaml","docs.zip":"/myRulesetFolder/ruleset.doc.zip"}'
----
