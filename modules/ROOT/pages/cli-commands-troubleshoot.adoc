...
* Specifying a type but uploading more than one file type as multiple options in a single --files flag, as you do with a ruleset and its documentation. It is best to let the system infer the correct file type -- in this case, ruleset. 
