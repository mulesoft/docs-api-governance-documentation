...
After Anypoint API Governance identifies conformance issues in your API, you can view the governance validation report details to get information about the issues. Nonconformance messages give information about conformance issues and contextual links direct you to the best place to address them. 
