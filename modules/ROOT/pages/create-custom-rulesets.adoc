...
. Read https://a.ml/docs/[Getting Started with AMF^] to understand for a brief summary of AMF and the AMF Contract Model. 
...
. Install Anypoint CLI. You'll need this to validate, generate documentation, and publish your custom rulesets.
