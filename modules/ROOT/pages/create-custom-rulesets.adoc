...
NOTE: Similarly to custom code and configurations, rulesets that you create are not considered supported MuleSoft products. For assistance with issues with these custom rulesets, you can post an issue in the Github repository for the https://github.com/aml-org/amf-custom-validator[AMF Custom Validator^].
