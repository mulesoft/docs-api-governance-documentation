...
If you need a ruleset other than what is provided, you can create your own custom ruleset. You can also submit your ideas for rulesets you would like MuleSoft to provide in future releases on the https://help.mulesoft.com/s/ideas[MuleSoft Ideas Portal^]. 
...
After you modify or create a custom ruleset, you must generate its documentation, validate it to ensure the syntax is correct, and then upload it to Exchange to publish it. See xref:custom-rulesets-validate-and-publish.adoc[].