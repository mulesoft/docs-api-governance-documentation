...
Creating custom rulesets requires installing and running CLI commands and depending on the approach you take, writing modeling language code. If you aren't familiar with CLI and modeling languages, consider enlisting help creating your custom rulesets. 
