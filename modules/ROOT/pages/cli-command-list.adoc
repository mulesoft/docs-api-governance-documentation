...
|===
|Command |Description
| xref:monitor-api-conformance.adoc#governance-api-evaluate[governance api evaluate] | Evaluates filter criteria to determine which rulesets would potentially apply to APIs that meet that criteria
