...
|===
|Command |Description
| xref:find-conformance-issues.adoc#governance-api-validate[governance api validate] | Validates the API definition against rulesets
...
| xref:create-custom-rulesets.adoc#governance-ruleset-validate[governance ruleset validate] | Validates the governance ruleset definition's format
|===
