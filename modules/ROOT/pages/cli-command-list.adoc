...
|===
|Command |Description
| xref:monitor-api-conformance.adoc#governance-api-evaluate[governance api evaluate] | Evaluates an API project to determine which rulesets would be applied to this API for given filters
