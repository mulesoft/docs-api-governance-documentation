...
. Validate the custom ruleset using Anypoint CLI.
. Generate the documentation for the ruleset using Anypoint CLI.
. Publish (upload) the customized ruleset as a new ruleset asset along with its associated documentation using Anypoint CLI. 
