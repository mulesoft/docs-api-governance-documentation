...
You can use Anypoint CLI to <<list-rules,list the rules>> before you modify your ruleset so that you can see what you want to change and after you change it to validate your changes. 
...
.. Downloads the ruleset to the `~/MyRulesetFolder` folder.
