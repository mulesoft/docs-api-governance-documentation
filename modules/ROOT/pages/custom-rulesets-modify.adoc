...
If a published ruleset meets most of your needs and you need to make only a few changes, a quick way to create your custom ruleset is to download the ruleset from Exchange, modify the rules, and publish the customized ruleset as a new asset. 
...
* Before you modify your ruleset so that you can see what you want to change
* After you change it to validate your changes 
