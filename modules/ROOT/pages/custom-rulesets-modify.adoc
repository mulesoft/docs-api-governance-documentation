...
anypoint-cli-v4 exchange asset download 68ef9520-24e9-4cf2-b2f5-620025690913/anypoint-best-practices/1.0.2 MyRulesetFolder
...
.. Clones the downloaded ruleset, `myruleset.yaml`, and puts the `operation-default-response` and `operation-operationId` rules in the warning section.
