= Finding and correcting conformance issues as you author API definitions

Rulesets can be applied to API definitions as you are authoring them, either in Design Center
or with the CLI. You can also validate rulesets to make sure they are formatted correctly with the CLI.
...
== Validate Rulesets and API Definitions with the CLI
...
*Description:* Validates the Ruleset definition's format.
