...
* Review how the AWS API properties map to Anypoint Platform API parameters and if feasible, update the API parameters in AWS to help ensure the information maps more closely to what you want.
* Some parameters map to a default in API Discovery, such as the API version, which defaults to the datetime stamp. After you run the scan to discover the APIs and as you prepare to publish, you can update some of the API information. See xref:publish-discovered-apis.adoc[].
