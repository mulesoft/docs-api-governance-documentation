...
.. After you test settings using draft profiles, xref:create-profiles.adoc#activate-draft-profile[activate the profiles] to notify developers and reveal the resulting API conformance information across Anypoint Platform.
