...
+
The API Governance console enables you to monitor and report on your organization's conformance success and failure. Inform API authors through notifications that they need to update their API definitions to meet standards. 
