...
After you become familiar with the API Governance UI and concepts covered in the xref:api-gov.adoc[API Governance Overview], you are ready to get started governing your APIs. 
...
+
Add profiles in the API Governance console or use the governance CLI to group and apply rulesets to sets of APIs. 
...
+
When you view a validated API asset in Exchange, select the *Conformance Status* page to view conformance information for that API.
