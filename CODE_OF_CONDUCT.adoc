...
All complaints are reviewed and investigated  and will result in a response that is deemed necessary and appropriate to the  circumstances.
...
It includes adaptions and additions from https://golang.org/conduct[Go Community Code of Conduct],  https://github.com/cncf/foundation/blob/master/code-of-conduct.md[CNCF Code of Conduct], and https://opensource.microsoft.com/codeofconduct/[Microsoft Open Source Code of Conduct].
